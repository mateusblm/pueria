...
export class AlimentacaoCriancaComponent implements OnInit {
  ...
  readonly form = this.fb.group({
    ...
    alimentadoExclusivamentePorCuidador: [false],
  ...
  editar(registro: RegistroAlimentacao): void {
    ...
    this.form.patchValue({
      ...
      alimentadoExclusivamentePorCuidador: !!registro.alimentadoExclusivamentePorCuidador,
  ...
  private criarRequest(): SalvarRegistroAlimentacaoRequest {
    ...
    return {
      ...
      alimentadoExclusivamentePorCuidador: valor.alimentadoExclusivamentePorCuidador,
