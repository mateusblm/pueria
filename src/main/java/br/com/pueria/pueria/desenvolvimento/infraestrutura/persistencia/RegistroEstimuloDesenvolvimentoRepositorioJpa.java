...
@Repository public class RegistroEstimuloDesenvolvimentoRepositorioJpa implements RegistroEstimuloDesenvolvimentoRepositorio {
 ...
 public List<RegistroEstimuloDesenvolvimento> listarPorCrianca(UUID id){return repository.findByCriancaIdOrderByExperimentadoEmDesc(id).stream().map(this::paraDominio).toList();}
